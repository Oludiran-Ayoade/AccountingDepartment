              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-120px)]">
                {isLoadingNotes ? (
                  ...
                  <div className="text-center py-16">
                    ...
                    <h3 className="text-2xl font-bold text-foreground mb-2">No notes available</h3>
                    <p className="text-muted-foreground text-lg">No notes have been uploaded for this course yet.</p>
                  </div>
                ) : (
                  <div className="space-y-5">
                    {courseNotes.map((note) => (
                      <div key={note.id} className="group bg-gradient-to-br from-background to-background/80 rounded-2xl shadow-md hover:shadow-xl border border-border/50 hover:border-primary/30 transition-all duration-300 overflow-hidden">
                        <div className="p-5">
                          <div className="flex items-start justify-between gap-4">
                            <div className="flex-1">
                              <h3 className="text-xl font-bold text-foreground mb-2 group-hover:text-primary transition-colors">{note.title}</h3>
                              <p className="text-sm text-muted-foreground mb-4 leading-relaxed">{note.description}</p>
                              <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
                                ...
                                <span className="px-2.5 py-1 rounded-lg bg-gradient-to-r from-primary/10 to-primary/5 text-primary text-xs font-semibold">{note.fileType || 'PDF'}</span>
                              </div>
                            </div>
