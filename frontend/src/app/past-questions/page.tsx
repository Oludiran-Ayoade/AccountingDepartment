              ...
              <div className="p-3 sm:p-6 overflow-y-auto max-h-[calc(95vh-100px)] sm:max-h-[calc(90vh-120px)]">
                {isLoadingPastQuestions ? (
                  ...
                  <div className="text-center py-8 sm:py-16">
                    ...
                    <h3 className="text-xl sm:text-2xl font-bold text-foreground mb-2">No past questions available</h3>
                    <p className="text-muted-foreground text-base sm:text-lg">No past questions have been uploaded for this course yet.</p>
                  </div>
                ) : (
                  <div className="space-y-3 sm:space-y-5">
                    {coursePastQuestions.map((pq) => (
                      <div key={pq.id} className="group bg-gradient-to-br from-background to-background/80 rounded-xl sm:rounded-2xl shadow-md hover:shadow-xl border border-border/50 hover:border-primary/30 transition-all duration-300 overflow-hidden">
                        <div className="p-3 sm:p-5">
                          <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
                            <div className="flex-1 w-full">
                              <h3 className="text-base sm:text-xl font-bold text-foreground mb-1 sm:mb-2 group-hover:text-primary transition-colors">{pq.title}</h3>
                              <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4 leading-relaxed line-clamp-2">{pq.description}</p>
                              <div className="flex flex-wrap items-center gap-2 sm:gap-4 text-xs sm:text-sm text-muted-foreground">
                                ...
                                <span className="px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg bg-gradient-to-r from-primary/10 to-primary/5 text-primary text-xs font-semibold">PDF</span>
                              </div>
                            </div>
